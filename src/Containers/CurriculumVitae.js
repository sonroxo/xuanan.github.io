    ...
    <div className="sm:w-full md:w-6/12 m-auto">
      ...
      <div className="p-2">
        ...
        <div className="w-[350px] m-auto ">
          ...
          <p className="p-2">
            <strong>DOB:</strong> 1992
          </p>
          <p className="p-2">
            <strong>Address:</strong> Hanoi
          </p>
          <p className="p-2">
            <strong>Email:</strong> nguyentruongxuananhn@gmail.com
          </p>
          <p className="p-2">
            <strong>Phone:</strong> 0919.871.216
          </p>
        </div>
      </div>
      ...
      <ul>
        <li>- Business model is similar with The Coffee Beans and Starbuck.</li>
        <li>Manage over 20 employees for the shop, full-time and part-time.</li>
        <li>Product-testing, design to fit customer’s target.</li>
        <li>Process payrulls, payslips and accounting for the shop.</li>
        <li>Deal with customers’ feedback.</li>
        <li>Marketing for the shop.</li>
        <li>Break-even within a year. Stop to apply graduate schoul.</li>
      </ul>

      <div className="h-8 " name="break" />
      <h3>Education</h3>
      <h6>MBA Business Administration</h6>
      <ul>
        <li>McNeese State University, Lake Charles, Louisiana, USA.</li>
        <li>Graduate at 12/2016.</li>
      </ul>
      ...
      <div className="h-8 " name="break" />
      <h3>References</h3>
      <h6>McNeese State University</h6>
      <ul>
        <li class="list-inline-item">Reference: Dr.Chen</li>
        <li class="list-inline-item">Email: jschen@mcneese.edu</li>
      </ul>
      <div className="h-8 " name="break" />
